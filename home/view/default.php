...
$all_expressions = Conn::queryArrays("
        SELECT
        ...
        WHERE enumDeleted = 'N'
        AND   strLanguageISO6391 = ".goodInput($_REQUEST['lang'] == 'fr' ? 'fr' : 'en')."
        ORDER BY expression");
...
?>
        ...
        <div id="list-view-container">
        	...
        	<table id="listview" class="table table table-striped table-bordered">
        		...
        		<tbody><?php
        			for ($i=0; $i<count($all_expressions); $i++) {
	        			echo formatResultRow($all_expressions[$i]);
        			}
        		?></tbody>
        	</table>
        </div>
        ...
        <div id="record-view-container" class="hide">
            <form id="iemlRecord" method="POST" action="ajax.php">
			...
			<form method="post" id="formLogin" class="hide">
        ...
        <div class="modal hide" id="iemlAddUserModal">
        	...
        	<div class="modal-body">
            	<form class="form-horizontal" id="iemlUser" method="POST" action="ajax.php">
