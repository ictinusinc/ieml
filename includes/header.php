		...
		<div class="ieml-top-nav" role="navigation">
				...
				<div class="row">
					<form id="search-form" action="/api/" method="post" role="search">
						...
						<div class="col-sm-3">
							<div class="row">
								<div class="col-sm-6">
									<select id="search-spec-select" name="lexicon" class="form-control input-sm"><option value="BasicLexicon">Basic Lexicon</option></select>
								</div>
								<div class="col-sm-6">
			...
			<div class="subtop-bar">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<div class="pull-left" id="add-ieml-record-wrap"><a href="javascript:void(0);" class="btn btn-default" id="add-ieml-record"><span class="glyphicon glyphicon-plus">&nbsp;</span><span data-lang-switch="add_record"><?php echo trans_phrase('add_record', $lang); ?></span></a></div>
							<div class="pull-left" id="ieml-view-users-wrap"><a href="javascript:void(0);" class="btn btn-default" id="ieml-view-users" data-lang-switch="view_users"><?php echo trans_phrase('view_users', $lang); ?></a></div>
