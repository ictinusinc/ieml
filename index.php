...
<div class="container user-padding">
    ...
    <div id="user-view-container" class="hide">
        <div class="row">
            ...
            <div class="span3"><a href="#" id="addUser" class="btn pull-right" data-lang-switch="add_user"><?php echo trans_phrase('add_user', $lang); ?></a></div>
        </div>
    	<table id="userlist" class="table table table-striped table-bordered"><thead><tr><th data-lang-switch="user_tab_user_col"><?php echo trans_phrase('user_tab_user_col', $lang); ?></th><th data-lang-switch="user_tab_type_col"><?php echo trans_phrase('user_tab_type_col', $lang); ?></th><th data-lang-switch="user_tab_created_col"><?php echo trans_phrase('user_tab_created_col', $lang); ?></th><th>&nbsp;</th></tr></thead><tbody></tbody></table>
    </div>
    
    <div id="list-view-container" class="hide">
        <div class="row">
            <div class="span12"><h3 data-lang-switch="results"><?php echo trans_phrase('results', $lang); ?></h3></div>
        </div>
    	<table id="listview" class="table table table-striped table-bordered">
    		<thead><tr><th data-lang-switch="list_tab_exp_col"><?php echo trans_phrase('list_tab_exp_col', $lang); ?></th><th data-lang-switch="list_tab_descriptor_col"><?php echo trans_phrase('list_tab_descriptor_col', $lang); ?></th><th>&nbsp;</th></tr></thead>
    		<tbody></tbody>
    	</table>
    </div>
    ...
    <div id="record-view-container" class="hide">
        <form id="iemlRecord" method="POST" action="/api/">
            ...
            <div class="row">
            	<div class="span12">
					<span data-lang-switch="paradigmatic_curcuits"><?php echo trans_phrase('paradigmatic_curcuits', $lang); ?></span>
    ...
    <div class="modal hide" id="iemlConfirmModal">
    	<div class="modal-header"><a class="close" data-dismiss="modal">x</a><h3>Add Record</h3></div>
    ...
    <div class="modal hide" id="iemlAddUserModal">
    	<div class="modal-header"><a class="close" data-dismiss="modal">x</a><h3 data-lang-switch="add_user"><?php echo trans_phrase('add_user', $lang); ?></h3></div>
