...
?>
        ...
        <div class="modal hide" id="iemlAddUserModal">
        	<div class="modal-header"><a class="close" data-dismiss="modal" id="iemlConfirmXModal">x</a data-lang-switch="add_user"><h3><?php echo trans_phrase('add_user', $lang); ?></h3></div>
